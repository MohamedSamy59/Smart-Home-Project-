...
# 15 "./DC_MOTOR/../GPIO_MODULES/hal_GPIO.h"
...
# 15 "./DC_MOTOR/../GPIO_MODULES/std_libraries.h"
    ...
    while (1)
    {
        ...
        switch(ggggg){
            ...
            case 'd': ecu_led_off(&led);
                        ggggg=0;
            break;
            case 'e': (LATE |= ((uint8)1 << 1));
                        _delay((unsigned long)((.5)*(1000000/4000.0)));
                        (LATE &= ~((uint8)1 << 1));
                       _delay((unsigned long)((1000)*(1000000/4000.0)));
                        ggggg=0;
            break;
            case 'q': (LATE |= ((uint8)1 << 1));
                       _delay((unsigned long)((10.4999)*(1000000/4000.0)));
                       (LATE &= ~((uint8)1 << 1));
                       _delay((unsigned long)((1000)*(1000000/4000.0)));
                        ggggg=0;
            break;
            case 'm': (LATB |= ((uint8)1 << 0));
                       (LATB |= ((uint8)1 << 2));

                        ggggg=0;
            break;
            case 'l': (LATB &= ~((uint8)1 << 0));
                       (LATB &= ~((uint8)1 << 2));
