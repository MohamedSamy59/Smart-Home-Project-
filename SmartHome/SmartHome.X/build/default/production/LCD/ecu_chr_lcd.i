...
Std_ReturnType ecu_lcd_4_bits_initialization(const mode_4_bits_t *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        ret = ecu_lcd_4_bits_send_command(lcd,0X38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        ret = ecu_lcd_4_bits_send_command(lcd,0X38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        ret = ecu_lcd_4_bits_send_command(lcd,0X38);

        ret = ecu_lcd_4_bits_send_command(lcd,0X01);
        ret = ecu_lcd_4_bits_send_command(lcd,0X02);
        ret = ecu_lcd_4_bits_send_command(lcd,0X06);
        ret = ecu_lcd_4_bits_send_command(lcd,0X0C);
        ret = ecu_lcd_4_bits_send_command(lcd,0X80);


        ret = ecu_lcd_4_bits_send_command(lcd,0X28);
...
Std_ReturnType ecu_lcd_4_bits_send_custom_char_data_pos(const mode_4_bits_t *lcd,const uint8 cha[],uint8 row,uint8 column,uint8 cha_mem_pos){
    ...
    if(((void*)0) == lcd ){
        ...
        ret=ecu_lcd_4_bits_send_command(lcd,(0X40 +cha_mem_pos*8));
...
Std_ReturnType ecu_lcd_8_bits_initialization(const mode_8_bits_t *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        ret = gpio_pin_direction_intialization(&(lcd->lcd_register_select));
        ret = gpio_pin_direction_intialization(&(lcd->lcd_enable_pin));
        for(counter = 0X00;counter<=7;counter++){
         ret = gpio_pin_direction_intialization(&(lcd->lcd_data[counter]));

        }
        _delay((unsigned long)((20)*(8000000/4000.0)));
        ret = ecu_lcd_8_bits_send_command(lcd,0X38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        ret = ecu_lcd_8_bits_send_command(lcd,0X38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        ret = ecu_lcd_8_bits_send_command(lcd,0X38);

        ret = ecu_lcd_8_bits_send_command(lcd,0X01);
        ret = ecu_lcd_8_bits_send_command(lcd,0X02);
        ret = ecu_lcd_8_bits_send_command(lcd,0X06);
        ret = ecu_lcd_8_bits_send_command(lcd,0X0C);

        ret = ecu_lcd_8_bits_send_command(lcd,0X80);
...
Std_ReturnType ecu_lcd_8_bits_send_custom_char_data_pos(const mode_8_bits_t *lcd,const uint8 cha[],uint8 row,uint8 column,uint8 cha_mem_pos){
    ...
    if(((void*)0) == lcd ){
        ...
        ret=ecu_lcd_8_bits_send_command(lcd,(0X40 +cha_mem_pos*8));
        for(counter = 0X00;counter<8;counter++){
...
static Std_ReturnType send_4bits_set_cursor(const mode_4_bits_t *lcd,uint8 row,uint8 column){
        ...
        column--;
        switch(row){
            case 1 : ecu_lcd_4_bits_send_command(lcd,(0x80+column));
            break;
            case 2 : ecu_lcd_4_bits_send_command(lcd,(0xc0+column));
            break;
            case 3 : ecu_lcd_4_bits_send_command(lcd,(0x94+column));
            break;
            case 4 : ecu_lcd_4_bits_send_command(lcd,(0xd4+column));
            break;
            default:;
...
static Std_ReturnType send_8bits_set_cursor(const mode_8_bits_t *lcd,uint8 row,uint8 column){
        ...
        column--;
        switch(row){
            case 1 : ecu_lcd_8_bits_send_command(lcd,(0x80+column));
            break;
            case 2 : ecu_lcd_8_bits_send_command(lcd,(0xc0+column));
            break;

            case 3 : ecu_lcd_8_bits_send_command(lcd,(0x94+column));
            break;

            case 4 : ecu_lcd_8_bits_send_command(lcd,(0xd4+column));
            break;
            default:;
