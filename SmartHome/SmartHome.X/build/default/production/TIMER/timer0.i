...
# 1 "TIMER/../GPIO_MODULES/hal_GPIO.h" 1
# 13 "TIMER/../GPIO_MODULES/hal_GPIO.h"
...
# 13 "TIMER/../GPIO_MODULES/hal_GPIO.h" 2


# 1 "TIMER/../GPIO_MODULES/compiler.h" 1
# 11 "TIMER/../GPIO_MODULES/compiler.h"
...
# 11 "TIMER/../GPIO_MODULES/compiler.h" 2
# 15 "TIMER/../GPIO_MODULES/hal_GPIO.h" 2

# 1 "TIMER/../GPIO_MODULES/mcal_std_types.h" 1
# 12 "TIMER/../GPIO_MODULES/mcal_std_types.h"
# 1 "TIMER/../GPIO_MODULES/std_libraries.h" 1
# 13 "TIMER/../GPIO_MODULES/std_libraries.h"
...
# 13 "TIMER/../GPIO_MODULES/std_libraries.h" 2
...
# 15 "TIMER/../GPIO_MODULES/std_libraries.h" 2
...
# 16 "TIMER/../GPIO_MODULES/std_libraries.h" 2
# 12 "TIMER/../GPIO_MODULES/mcal_std_types.h" 2
# 21 "TIMER/../GPIO_MODULES/mcal_std_types.h"
...
# 16 "TIMER/../GPIO_MODULES/hal_GPIO.h" 2


# 1 "TIMER/../GPIO_MODULES/hal_gpio_cfg.h" 1
# 18 "TIMER/../GPIO_MODULES/hal_GPIO.h" 2

# 1 "TIMER/../GPIO_MODULES/device_config.h" 1
# 19 "TIMER/../GPIO_MODULES/hal_GPIO.h" 2
# 38 "TIMER/../GPIO_MODULES/hal_GPIO.h"
typedef enum {
    GPIO_PIN0,
    GPIO_PIN1,
    GPIO_PIN2,
...
static uint16 saved_preload_value=0X00;
Std_ReturnType mcal_timer0_initialization (timer0_t *timer){
...
Std_ReturnType mcal_timer0_write (timer0_t *timer,uint16 preload_value){
    ...
    if(timer->timer_reg_size == 1){
        TMR0L=(uint8)(preload_value);
    }
    else if(timer->timer_reg_size == 0){
...
Std_ReturnType mcal_timer0_read (timer0_t *timer,uint16 *value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    uint8 timer0_L=0X00,timer0_H=0X00;
...
static Std_ReturnType timer_mode_helper(timer0_t *timer){
    if(timer->timer_mode == 0){
        (T0CONbits.T0CS=0);
    }
    else if(timer->timer_mode == 1){
        (T0CONbits.T0CS=1);
        (TRISA |= ((uint8)1 << 0x4));
        if(timer->timer_edge == 0){
            (T0CONbits.T0SE=0);
        }
        else if(timer->timer_edge == 1){
            (T0CONbits.T0SE=1);
        }
        else{ }
    }
...
static Std_ReturnType prescaler_helper(timer0_t *timer){
    if(timer->prescaler_on_off == 0){
        (T0CONbits.PSA=0);
        T0CONbits.T0PS=timer->prescaler_mode;
    }
    else if(timer->prescaler_on_off == 1){
        (T0CONbits.PSA=1);
    }
    else{ }
}
