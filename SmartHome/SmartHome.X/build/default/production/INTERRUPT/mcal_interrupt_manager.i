# 1 "INTERRUPT/mcal_interrupt_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "INTERRUPT/mcal_interrupt_manager.c" 2
...
# 1 "INTERRUPT/mcal_interrupt_manager.h" 1
# 13 "INTERRUPT/mcal_interrupt_manager.h"
...
# 13 "INTERRUPT/mcal_interrupt_manager.h" 2
# 34 "INTERRUPT/mcal_interrupt_manager.h"
void ISR_TIMER0(void);
# 9 "INTERRUPT/mcal_interrupt_manager.c" 2
...
void __attribute__((picinterrupt(("high_priority"))))interrupt_high(void){
# 86 "INTERRUPT/mcal_interrupt_manager.c"
     if((INTCONbits.T0IF==1)&&(INTCONbits.T0IE==INTERRUPT_ENABLE)){
             ISR_TIMER0();

    }
    else{}
# 151 "INTERRUPT/mcal_interrupt_manager.c"
}


void __attribute__((picinterrupt(("low_priority"))))interrupt_low(void){
# 218 "INTERRUPT/mcal_interrupt_manager.c"
     if((INTCONbits.T0IF==1)&&(INTCONbits.T0IE==INTERRUPT_ENABLE)){
             ISR_TIMER0();

    }
    else{}
# 284 "INTERRUPT/mcal_interrupt_manager.c"
}
