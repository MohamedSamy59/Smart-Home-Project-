# 1 "INTERRUPT/mcal_internal_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "INTERRUPT/mcal_internal_interrupt.c" 2
...
# 1 "INTERRUPT/mcal_internal_interrupt.h" 1
# 12 "INTERRUPT/mcal_internal_interrupt.h"
...
# 12 "INTERRUPT/mcal_internal_interrupt.h" 2
# 170 "INTERRUPT/mcal_internal_interrupt.h"
 void ADC_handler_init(void (*_handler)(void));
# 9 "INTERRUPT/mcal_internal_interrupt.c" 2
