...
# 1 "GPIO_MODULES/hal_GPIO.h" 1
# 13 "GPIO_MODULES/hal_GPIO.h"
...
# 13 "GPIO_MODULES/hal_GPIO.h" 2


# 1 "GPIO_MODULES/compiler.h" 1
# 11 "GPIO_MODULES/compiler.h"
...
# 11 "GPIO_MODULES/compiler.h" 2
# 15 "GPIO_MODULES/hal_GPIO.h" 2

# 1 "GPIO_MODULES/mcal_std_types.h" 1
# 12 "GPIO_MODULES/mcal_std_types.h"
# 1 "GPIO_MODULES/std_libraries.h" 1
# 13 "GPIO_MODULES/std_libraries.h"
...
# 13 "GPIO_MODULES/std_libraries.h" 2
...
# 15 "GPIO_MODULES/std_libraries.h" 2
...
# 16 "GPIO_MODULES/std_libraries.h" 2
# 12 "GPIO_MODULES/mcal_std_types.h" 2
# 21 "GPIO_MODULES/mcal_std_types.h"
...
# 16 "GPIO_MODULES/hal_GPIO.h" 2


# 1 "GPIO_MODULES/hal_gpio_cfg.h" 1
# 18 "GPIO_MODULES/hal_GPIO.h" 2

# 1 "GPIO_MODULES/device_config.h" 1
# 19 "GPIO_MODULES/hal_GPIO.h" 2
# 38 "GPIO_MODULES/hal_GPIO.h"
typedef enum {
    GPIO_PIN0,
    GPIO_PIN1,
    GPIO_PIN2,
...
Std_ReturnType gpio_pin_direction_status (const pin_config_t *_pin_config, direction_t *direction_status)
{
    ...
    if(((void*)0)==_pin_config || ((void*)0)==direction_status || _pin_config->pin > 8 -1)
    {
        ...
        *direction_status = ((uint8)1 & (*tris_reg[_pin_config->port] >> _pin_config->pin));
    }
    return ret;
}
...
Std_ReturnType gpio_pin_read_logic (const pin_config_t *_pin_config, logic_t *logic){
    ...
    {
   *logic = ((uint8)1 & (*port_reg[_pin_config->port] >> _pin_config->pin));
    }
    return ret;
}
...
Std_ReturnType gpio_port_direction_status (port_index_t port, uint8 *direction_status){
    ...
    if(port>5 -1 || direction_status ==((void*)0))
    {
        ret= (Std_ReturnType)0x01;
    }
    else
