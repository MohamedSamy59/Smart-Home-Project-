...
# 13 "Keypad/ecu_keypad.h"
# 1 "Keypad/../GPIO_MODULES/hal_GPIO.h" 1
# 13 "Keypad/../GPIO_MODULES/hal_GPIO.h"
...
# 13 "Keypad/../GPIO_MODULES/hal_GPIO.h" 2


# 1 "Keypad/../GPIO_MODULES/compiler.h" 1
# 11 "Keypad/../GPIO_MODULES/compiler.h"
...
# 11 "Keypad/../GPIO_MODULES/compiler.h" 2
# 15 "Keypad/../GPIO_MODULES/hal_GPIO.h" 2

# 1 "Keypad/../GPIO_MODULES/mcal_std_types.h" 1
# 12 "Keypad/../GPIO_MODULES/mcal_std_types.h"
# 1 "Keypad/../GPIO_MODULES/std_libraries.h" 1
# 13 "Keypad/../GPIO_MODULES/std_libraries.h"
...
# 13 "Keypad/../GPIO_MODULES/std_libraries.h" 2
...
# 15 "Keypad/../GPIO_MODULES/std_libraries.h" 2
...
# 16 "Keypad/../GPIO_MODULES/std_libraries.h" 2
# 12 "Keypad/../GPIO_MODULES/mcal_std_types.h" 2
# 21 "Keypad/../GPIO_MODULES/mcal_std_types.h"
...
# 16 "Keypad/../GPIO_MODULES/hal_GPIO.h" 2


# 1 "Keypad/../GPIO_MODULES/hal_gpio_cfg.h" 1
# 18 "Keypad/../GPIO_MODULES/hal_GPIO.h" 2

# 1 "Keypad/../GPIO_MODULES/device_config.h" 1
# 19 "Keypad/../GPIO_MODULES/hal_GPIO.h" 2
# 38 "Keypad/../GPIO_MODULES/hal_GPIO.h"
typedef enum {
    GPIO_PIN0,
    GPIO_PIN1,
    GPIO_PIN2,
...
# 9 "Keypad/ecu_keypad.c" 2





static const uint8 arr[4][4] = {{'7','8','9','/'},{'4','5','6','*'},{'1','2','3','-'},{'#','0','=','+'}};
...
Std_ReturnType ecu_keypad_initialization(const keypad_t *keypad){
    ...
    if(((void*)0) == keypad){
        ...
        for(counter1=0X00;counter1<4;counter1++){
            ret = gpio_pin_initialization(&(keypad->row_pin[counter1]));
        }
         for(counter2=0X00;counter2<4;counter2++){
...
Std_ReturnType ecu_keypad_get_value(const keypad_t *keypad,uint8 *value){
    ...
    if((((void*)0) == keypad)||(((void*)0) == value)){
        ...
        for(counter1=0X00;counter1<4;counter1++){
            counter2 = powf(2,counter1);
            for(counter3=0X00 ; counter3<4;counter3++){
                  ret =gpio_pin_write_logic(&(keypad->row_pin[counter3]),(counter2 >> counter3) & 0x01);

            }


         for(counter4=0X00;counter4<4;counter4++){
